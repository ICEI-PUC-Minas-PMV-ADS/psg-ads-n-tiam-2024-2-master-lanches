...
const HomeScreen = () => {
    ...
    const renderMediumCardSection = () => <MediumCard onAddToCart={handleAddToCart} />;    
    const sections = [
        { title: 'NOVIDADES', key: 'novidades', render: renderLargeCardSection },
        { title: 'CATEGORIAS', key: 'categorias', render: renderSmallCardSection },
        { title: 'EXPLORAR', key: 'explorar', render: renderMediumCardSection },
    ];    
